...
{
    const float W = 700.f, H = 850.f; // Increased Height
    ...
    y_offset = 100;
    rhythmimickLbl.setBounds(S(250, y_offset, 220, 40));
    toggleRhythm.setBounds(S(550, y_offset, 120, 40));
    rhythmimickDescLbl.setBounds(S(-90, y_offset, 500, 120));
    arrowRhythm.setBounds(S(480, y_offset, 60, 40));

    recordUpTo60LblTop.setBounds(S(280, y_offset + 45, 180, 20));
    btnRec1.setBounds(S(280, y_offset + 65, 30, 30));
    playBtn.setBounds(S(320, y_offset + 65, 30, 30));
    rhythmSeek.setBounds(S(360, y_offset + 65, 140, 30));
    btnStop1.setBounds(S(510, y_offset + 65, 30, 30));

    btnGen1.setBounds(S(280, y_offset + 100, 90, 30));
    btnSave1.setBounds(S(380, y_offset + 100, 90, 30));
    btnDrag1.setBounds(S(480, y_offset + 100, 90, 30));

    // ---- Slapsmith row ----
    y_offset = 250;
    slapsmithLbl.setBounds(S(250, y_offset, 220, 40));
    toggleSlap.setBounds(S(550, y_offset, 120, 40));
    slapsmithDescLbl.setBounds(S(-90, y_offset, 500, 120));
    arrowSlap.setBounds(S(480, y_offset, 60, 40));

    miniGrid.setBounds(S(280, y_offset + 45, 250, 80));

    btnGen2.setBounds(S(280, y_offset + 130, 90, 30));
    btnSave2.setBounds(S(380, y_offset + 130, 90, 30));
    btnDrag2.setBounds(S(480, y_offset + 130, 90, 30));

    // ---- Style Blender row ----
    y_offset = 420;
    styleBlenderLbl.setBounds(S(250, y_offset, 220, 40));
    toggleBlend.setBounds(S(550, y_offset, 120, 40));
    styleBlenderDescLbl.setBounds(S(-90, y_offset, 500, 120));
    arrowBlend.setBounds(S(480, y_offset, 60, 40));

    styleABox.setBounds(S(280, y_offset + 45, 120, 28));
    styleBBox.setBounds(S(410, y_offset + 45, 120, 28));
    blendSlider.setBounds(S(280, y_offset + 80, 250, 20));

    btnGen3.setBounds(S(280, y_offset + 110, 90, 30));
    btnSave3.setBounds(S(380, y_offset + 110, 90, 30));
    btnDrag3.setBounds(S(480, y_offset + 110, 90, 30));

    // ---- Beatbox row (bottom) ----
    y_offset = 580;
    beatboxLbl.setBounds(S(250, y_offset, 220, 40));
    toggleBeat.setBounds(S(550, y_offset, 120, 40));
    beatboxDescLbl.setBounds(S(-90, y_offset, 500, 120));
    arrowBeat.setBounds(S(480, y_offset, 60, 40));

    recordUpTo60LblBottom.setBounds(S(280, y_offset + 45, 180, 20));
    btnRec4.setBounds(S(280, y_offset + 65, 30, 30));
    btnPlay4.setBounds(S(320, y_offset + 65, 30, 30));
    beatboxSeek.setBounds(S(360, y_offset + 65, 140, 30));
    btnStop4.setBounds(S(510, y_offset + 65, 30, 30));

    btnGen4.setBounds(S(280, y_offset + 100, 90, 30));
    btnSave4.setBounds(S(380, y_offset + 100, 90, 30));
    btnDrag4.setBounds(S(480, y_offset + 100, 90, 30));

    // ---- Home button ----
    btnHome.setBounds(S(600, 750, 80, 80));
}
    ...
    : proc(p), onCloseFn(std::move(onClose)), onGenerateFn(std::move(onGen))
{
    ...
    barsLbl.setImage(loadSkin("barsLbl.png"));                addAndMakeVisible(barsLbl);
    styleLbl.setImage(loadSkin("styleLbl.png"));                addAndMakeVisible(styleLbl);
    timeSigLbl.setImage(loadSkin("timeSigLbl.png"));                addAndMakeVisible(timeSigLbl);
...
void RollsWindow::resized()
{
    ...
    const int comboSpacing = 10;
    const int totalComboWidth = comboBoxWidth * 2 + comboSpacing;
    int x = (W - totalComboWidth) / 2;
    int y = titleImageHeight + 30; // 30px space after title
    styleBox.setBounds(x, y, comboBoxWidth, comboBoxHeight);
    x += comboBoxWidth + comboSpacing;
    barsBox.setBounds(x, y, comboBoxWidth, comboBoxHeight);
    ...
    x = (W - totalButtonWidth) / 2;
    y += comboBoxHeight + 30; // 30px space after combos
    btnGenerate.setBounds(x, y, generateButtonWidth, buttonHeight);
    x += generateButtonWidth + buttonSpacing;
    btnSaveMidi.setBounds(x, y, otherButtonWidth, buttonHeight);
    x += otherButtonWidth + buttonSpacing;
    btnDragMidi.setBounds(x, y, otherButtonWidth, buttonHeight);
