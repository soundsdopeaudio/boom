    ...
    : proc(p), onCloseFn(std::move(onClose))
{
    ...
    addLbl(aiToolsDescLbl, "aiToolsDescLbl.png");
...
void AIToolsWindow::resized()
{
    ...
    selectAToolLbl.setBounds(S(525, 10, 160, 60));
    lockToBpmLbl.setBounds(S(10, 15, 100, 20));
    bpmLbl.setBounds(S(10, 35, 100, 20));
    bpmLockChk.setBounds(S(115, 10, 24, 24));

    // --- Descriptions ---
    aiToolsDescLbl.setBounds(S(5, -550, 200, 1600));

    int y = 100; // Initial y position for the first tool
    const int vertical_spacing = 190; // Increased space between tools
    const int label_height = 50; // Larger labels

    // --- Rhythm-Mimmick ---
    rhythmimickLbl.setBounds(S(250, y, 220, label_height));
    toggleRhythm.setBounds(S(550, y, 120, 40));
    arrowRhythm.setBounds(S(480, y, 60, 40));
    recordUpTo60LblTop.setBounds(S(280, y + 55, 180, 20));
    btnRec1.setBounds(S(280, y + 75, 30, 30));
    playBtn.setBounds(S(320, y + 75, 30, 30));
    rhythmSeek.setBounds(S(360, y + 75, 140, 30));
    btnStop1.setBounds(S(510, y + 75, 30, 30));
    btnGen1.setBounds(S(280, y + 110, 90, 30));
    btnSave1.setBounds(S(380, y + 110, 90, 30));
    btnDrag1.setBounds(S(480, y + 110, 90, 30));
    y += vertical_spacing;

    // --- Slap-Smith ---
    slapsmithLbl.setBounds(S(250, y, 220, label_height));
    toggleSlap.setBounds(S(550, y, 120, 40));
    arrowSlap.setBounds(S(480, y, 60, 40));
    miniGrid.setBounds(S(280, y + 55, 250, 80));
    btnGen2.setBounds(S(280, y + 140, 90, 30));
    btnSave2.setBounds(S(380, y + 140, 90, 30));
    btnDrag2.setBounds(S(480, y + 140, 90, 30));
    y += vertical_spacing;

    // --- Style-Blender ---
    styleBlenderLbl.setBounds(S(250, y, 220, label_height));
    toggleBlend.setBounds(S(550, y, 120, 40));
    arrowBlend.setBounds(S(480, y, 60, 40));
    styleABox.setBounds(S(280, y + 55, 120, 28));
    styleBBox.setBounds(S(410, y + 55, 120, 28));
    blendSlider.setBounds(S(280, y + 90, 250, 20));
    btnGen3.setBounds(S(280, y + 120, 90, 30));
    btnSave3.setBounds(S(380, y + 120, 90, 30));
    btnDrag3.setBounds(S(480, y + 120, 90, 30));
    y += vertical_spacing;

    // --- Beatbox ---
    beatboxLbl.setBounds(S(250, y, 220, label_height));
    toggleBeat.setBounds(S(550, y, 120, 40));
    arrowBeat.setBounds(S(480, y, 60, 40));
    recordUpTo60LblBottom.setBounds(S(280, y + 55, 180, 20));
    btnRec4.setBounds(S(280, y + 75, 30, 30));
    btnPlay4.setBounds(S(320, y + 75, 30, 30));
    beatboxSeek.setBounds(S(360, y + 75, 140, 30));
    btnStop4.setBounds(S(510, y + 75, 30, 30));
    btnGen4.setBounds(S(280, y + 110, 90, 30));
    btnSave4.setBounds(S(380, y + 110, 90, 30));
    btnDrag4.setBounds(S(480, y + 110, 90, 30));
