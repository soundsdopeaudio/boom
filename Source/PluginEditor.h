...
class BoomAudioProcessorEditor : public juce::AudioProcessorEditor,
    public juce::DragAndDropContainer, public juce::Timer
{
public:
...
class AIToolsWindow : public juce::Component, private juce::Timer
{
public:
...
private:
    ...
    juce::ImageComponent beatboxLbl, beatboxDescLbl, recordUpTo60LblBottom, lockToBpmLbl, bpmLbl;

    // Toggles
    juce::ImageButton toggleRhythm, toggleSlap, toggleBlend, toggleBeat;

    // Rhythmimick buttons
    juce::ImageButton btnRec1, playBtn, btnStop1, btnGen1, btnSave1, btnDrag1;
    ...
    enum class Tool { None, Rhythmimick, Slapsmith, StyleBlender, Beatbox };
    ...
    // Beatbox buttons
    juce::ImageButton btnRec4, btnPlay4, btnStop4, btnGen4, btnSave4, btnDrag4;
